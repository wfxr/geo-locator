...
internal abstract class LocatorTestBase : TestBase() {
    ...
    companion object {
        ...
        fun districtSample() = listOf(
            ...
            Arguments.of(310105, 31.2140750000, 121.4346470000, "上海市上海市长宁区"),
            Arguments.of(440305, 22.5240300000, 113.9247900000, "广东省深圳市南山区"),
            Arguments.of(370214, 36.3060538452, 120.4645857888, "山东省青岛市城阳区"))
